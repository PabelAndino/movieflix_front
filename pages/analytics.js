...
import FvtItemChart from "../src/otherUtils/analytics/FvtItemChart";
const SalesSummary = dynamic(
  () => import("../src/otherUtils/analytics/SalesSummary"),
  {
    ssr: false,
  }
);
const Revenue = dynamic(() => import("../src/otherUtils/analytics/Revenue"), {
  ssr: false,
});
const CustomerMapkm = dynamic(
  () => import("../src/otherUtils/analytics/CustomerMapkm"),
  {
    ssr: false,
  }
);
